...
*In this `homicide_raw` datasets, there are 52179 observations of 12
variables. It has 12 variable which are uid, reported\_date,
...
<img src="p8105_hw5_fs2757_files/figure-gfm/unnamed-chunk-7-1.png" width="90%" />

*From the plot, it is obviously shows that the observation on
participants from the experimental arm are higher than the control arm.
Furthermore, the experimental arm tend to increase while the observation
of the control arm stay roughly the same.*
